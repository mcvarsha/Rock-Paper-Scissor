...
#================================IMAGES========================================
blank_img=PhotoImage(file="1.png")
player_rock=PhotoImage(file="1.png")
sm_player_rock=player_rock.subsample(3, 3)
player_paper=PhotoImage(file="2.png")
sm_player_paper=player_paper.subsample(3, 3)
player_scissor=PhotoImage(file="3.png")
sm_player_scissor= player_scissor.subsample(3, 3)
com_rock=PhotoImage(file="4.png")
com_paper=PhotoImage(file="5.png")
com_scissor=PhotoImage(file="6.png")
